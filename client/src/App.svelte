...
<script>
  ...
  // TODO: set up new LogRocket project and update this
  // rename users in LogRocket dashboard by their platformId
  // LogRocket.init("92pbii/svsca");
  // LogRocket.identify(params.platformId, {
  //   name: params.platformId,
  //   email: params.platformId + "@example.com",
  // });
